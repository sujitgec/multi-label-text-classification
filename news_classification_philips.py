...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 24 14:36:01 2019
...
# Prepare Dataset
TRAIN_DATA = "/home/suk/Desktop/mls/news_classification/text_classification_using_gans_hans/data/philips_categories_cleaned.xlsx"
...
checkpoint_path = "/home/suk/Desktop/mls/news_classification/text_classification_using_gans_hans/checkpoint/training_1/cp.ckpt"
...
predictions = model.predict(np.expand_dims(x_train[92], 0))
predictions = model.predict(np.expand_dims(x_train[92], 0))
print(tokenizer.sequences_to_texts([x_train[92]]))
print(y_train[92])
print(predictions)
